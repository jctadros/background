...
def better_histogram(array, str):
    val = []
    ...
    return plt.hist(val, 100, label=str)

org_h, inp_h, lin_h = better_histogram(org, 'org'), better_histogram(inp, 'inp'), better_histogram(lin, 'lin')
plt.legend()
plt.show()
...
if mode == 'rect':
    bil_h = better_histogram(bil, 'bil')
